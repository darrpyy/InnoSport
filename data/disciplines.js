...
import attendance_chart from "../charts/attendance.js";
import {parseData} from "../charts/attendance.js";
    ...
    option.addEventListener('click', async function () {
        ...
        if (group_button.textContent === "All" || group_button.textContent === "Groups") {
                ...
                function fetchDataForClickedDisciplineAllGroups() {
                    return fetch("https://sport.innopolis.university/api/analytics/attendance?sport_id=" + disciplineId)
                        .then(response => response.json())
                        .then(data => data);
                }
            ...
            if (groupName === "All" || groupName === "Group") {
                ...
                function fetchDataForClickedGroupAndDiscipline() {
                    return fetch("https://sport.innopolis.university/api/analytics/attendance?medical_group_id=" + groupId + "&sport_id=" + disciplineId)
                        .then(response => response.json())
                        .then(data => data);
                }
